...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("fallback_release_lat_deg", default_value="22.886730"),
            DeclareLaunchArgument("fallback_release_lon_deg", default_value="113.495951"),
            DeclareLaunchArgument("fallback_release_radius_m", default_value="45.0"),
            DeclareLaunchArgument("visual_min_along_m", default_value="40.0"),
            DeclareLaunchArgument("visual_max_along_m", default_value="350.0"),
            DeclareLaunchArgument("visual_max_cross_m", default_value="80.0"),
                ...
                parameters=[
                    {
                        ...
                        "fallback_release_lat_deg": LaunchConfiguration("fallback_release_lat_deg"),
                        "fallback_release_lon_deg": LaunchConfiguration("fallback_release_lon_deg"),
                        "fallback_release_radius_m": LaunchConfiguration("fallback_release_radius_m"),
                        "visual_min_along_m": LaunchConfiguration("visual_min_along_m"),
                        "visual_max_along_m": LaunchConfiguration("visual_max_along_m"),
                        "visual_max_cross_m": LaunchConfiguration("visual_max_cross_m"),
