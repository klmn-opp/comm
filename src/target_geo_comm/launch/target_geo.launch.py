...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("sim_target_mode", default_value="fixed_distance"),
            DeclareLaunchArgument("sim_target_distance_m", default_value="80.0"),
            DeclareLaunchArgument("sim_target_distance_end_m", default_value="0.0"),
            DeclareLaunchArgument("sim_target_closing_speed_mps", default_value="0.0"),
            DeclareLaunchArgument("sim_target_reset_delay_s", default_value="3.0"),
                ...
                parameters=[
                    {
                        ...
                        "sim_target_mode": LaunchConfiguration("sim_target_mode"),
                        "sim_target_distance_m": LaunchConfiguration("sim_target_distance_m"),
                        "sim_target_distance_end_m": LaunchConfiguration("sim_target_distance_end_m"),
                        "sim_target_closing_speed_mps": LaunchConfiguration("sim_target_closing_speed_mps"),
                        "sim_target_reset_delay_s": LaunchConfiguration("sim_target_reset_delay_s"),
